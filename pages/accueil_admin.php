...
if(isset($_SESSION['email']) && isset($_GET['admin'])) {
?>
...
<main>
  <section class="pb-5 actu2">
    <div class="container py-4">
      <div class="divh2co text-center"><h2><strong>Mon compte admin</strong></h2></div>
      <hr>
      ...
      <div class="row justify-content-between">
          <div class="col-3"><a href="poster_actualite.php" class="profil"><i class="far fa-newspaper"></i> Poster actu</a></div>
          <div class="col-3"><a href="poster_evenement.php" class="profil"><i class="far fa-calendar-plus"></i> Poster évènement</a></div>
          <div class="col-3"><a href="poster_offre.php" class="profil"><i class="far fa-thumbs-up"></i> Poster offre</a></div>
      </div><br>
      <div class="row justify-content-between">
          <div class="col-3"><a href="poster_article.php" class="profil"><i class="far fa-edit"></i> Poster article</a></div>
          <div class="col-3"><a href="" class="profil"><i class="far fa-address-book"></i> Liste utilisateurs</a></div>
          <div class="col-3"><a href="" class="profil"><i class="far fa-question-circle"></i> Autre ?</a></div>
      </div><br>
        <br><br><br>
